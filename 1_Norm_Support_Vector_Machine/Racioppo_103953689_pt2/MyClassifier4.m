...
classdef MyClassifier4 < handle
    ...
    methods (Access = public)
        ...
        function obj = MyClassifier4(K,M,p)    % Class Constructor
            obj.K = K;
            obj.M = M;
            obj.W = [];
            obj.w = [];
...
%             obj = f_LineSearch2(obj,train_data,train_label);
            % Fit model:
        ...
        function [test_results] = TestCorrupted2(obj,test_data,p)
